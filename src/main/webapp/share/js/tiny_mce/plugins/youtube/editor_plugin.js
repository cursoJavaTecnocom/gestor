(function() {
	tinymce.create('tinymce.plugins.TinyMCE_YouTubePlugin', {
		init : function(ed, url) {
			...
			ed.addCommand('mceYoutube', function() {
				...
				ed.windowManager.open({
					...
					width : 450 + parseInt(ed.getLang('lang_youtube_delta_width', 0)),
					height : parseInt(ed.getLang('lang_youtube_delta_height', 0)),
					inline : 1
				}, {
					plugin_url : url
				});
			...
			ed.addButton('youtube', {
				title : 'youtube.lang_youtube_desc',
				cmd : 'mceYoutube',
			});
		},
	...
	*/
	...
	// Register plugin
	tinymce.PluginManager.add('youtube', tinymce.plugins.TinyMCE_YouTubePlugin);
})();
...
//tinyMCE.importPluginLanguagePack('youtube', 'es,en,nl');
