var tinymce = {majorVersion: '3', minorVersion: '2.0.1', releaseDate: '2008-09-17', _init: function() {
...
(function() {
    ...
    tinymce.create('tinymce.dom.DOMUtils', {doc: null, root: null, files: null, listeners: {}, pixelStyles: /^(top|left|bottom|right|width|height|borderWidth)$/, cache: {}, idPattern: /^#[\w]+$/, elmPattern: /^[\w_*]+$/, elmClassPattern: /^([\w_]*)\.([\w_]+)$/, props: {"for": "htmlFor", "class": "className", className: "className", checked: "checked", disabled: "disabled", maxlength: "maxLength", readonly: "readOnly", selected: "selected", value: "value"}, DOMUtils: function(d, s) {
            var t = this;
            t.doc = d;
            t.win = window;
            t.files = {};
    ...
    tinymce.create('tinymce.dom.ScriptLoader', {ScriptLoader: function(s) {
            ...
            function load(o) {
                if (o.state > 0)
                    return;
                o.state = 1;
                tinymce.util.XHR.send({url: o.url, error: t.settings.error, success: function(co) {
                        t.eval(co);
                        done(o);
                        allDone();
                    }});
