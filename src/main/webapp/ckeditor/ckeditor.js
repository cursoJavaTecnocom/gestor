...
(function() {
    ...
    e.extend(h.prototype, {type: 1, addClass: function(i) {
            ...
            for (var n = 0; n < l; n++) {
                var o = j[n];
                if ((!c || o.specified && o.nodeName != '_cke_expando') && o.nodeValue != i.getAttribute(o.nodeName))
                    return false;
            }
            if (c)
                for (n = 0; n < m; n++) {
                    o = k[n];
                    if (o.specified && o.nodeName != '_cke_expando' && o.nodeValue != this.getAttribute(o.nodeName))
                        return false;
                }
            return true;
        }, isVisible: function() {
            ...
            if (w)
                ...
                if (!y) {
                    ...
                    if (e.isArray(B)) {
                        t(B);
                        for (var C = 0; C < B.length; C++)
                            a.document.appendStyleSheet(B[C]);
                    } else {
                        B = u(B, a.getUrl(m[p]));
    ...
    (function() {
        ...
        a.htmlParser.fragment.fromHtml = function(p, q) {
            ...
            function B(E, F, G) {
                ...
                if (q && !F.type) {
                    var H, I;
                    if (E.attributes && (I = E.attributes._cke_real_element_type))
                        H = I;
                    else
                        H = E.name;
    ...
    (function() {
        function l(t, u) {
            ...
            if (this.current)
                ...
                if (w.endOffset > 0) {
                    ...
                    v = x(v, true) === false ? null : v.getPreviousSourceNode(true, z, x);
            } else {
                v = w.startContainer;
                ...
                if (v) {
                    ...
                    v = x(w.startContainer, true) === false ? null : w.startContainer.getNextSourceNode(true, z, x);
            }
            while (v && !this._.end) {
                this.current = v;
        ...
        h.prototype.getBogus = function() {
            ...
            if (t && (!c ? t.is && t.is('br') : t.getText && p.test(t.getText())))
                return t;
            return false;
        };
    })();
    ...
    (function() {
        ...
        d.range.prototype = {clone: function() {
                ...
                if (t.is && t.is('span') && t.hasAttribute('_fck_bookmark'))
                    v.setStartAt(t, 3);
                if (u && u.is && u.is('span') && u.hasAttribute('_fck_bookmark'))
                    v.setEndAt(u, 4);
            }, trim: function(t, u) {
                var B = this;
                ...
                if (!this.collapsed) {
                    ...
                    C.guard = function(G, H) {
                        if (t == a.SHRINK_ELEMENT && G.type == 3)
                            return false;
                        if (H && G.equals(D))
                            return false;
                        if (!H && G.type == 1)
    ...
    a.skins.add('kama', (function() {
        ...
        if (c && b.version < 7)
            l.push('icons.png', 'images/sprites_ie6.png', 'images/dialog_sides.gif');
    ...
    (function() {
        function l(p, q) {
            ...
            if (!r || r.getName() == 'body')
                return 2;
            if (r.getAscendant('blockquote', true))
                return 1;
            return 2;
        }
        ;
        ...
        var o = {exec: function(p) {
                ...
                if (q == 2) {
                    ...
                    while (J.length > 0) {
                        ...
                        I = P.getParent();
                        if (!P.getPrevious())
                            P.remove().insertBefore(I);
                        else if (!P.getNext())
                            P.remove().insertAfter(I);
                        else {
                    ...
                    if (p.config.enterMode == 2) {
                        ...
                        while (N.length) {
                            ...
                            if (P.getName() == 'div') {
                                ...
                                if (R)
                                    H.append(p.document.createElement('br'));
                                var S = P.getNext() && !(P.getNext().type == 1 && P.getNext().isBlockBoundary());
                                while (P.getFirst())
                                    P.getFirst().remove().appendTo(H);
                                if (S)
                                    H.append(p.document.createElement('br'));
                                H.replace(P);
                                Q = false;
    ...
    k.button.prototype = {canGroup: true, render: function(l, m) {
            ...
            if (n.opera || n.gecko && n.mac)
                m.push(' onkeypress="return false;"');
            if (n.gecko)
                m.push(' onblur="this.style.cssText = this.style.cssText;"');
            ...
            if (this.hasArrow)
                m.push('<span class="cke_buttonarrow">' + (b.hc ? '&#9660;' : '') + '</span>');
            m.push('</a>', '</span>');
            if (this.onRender)
                this.onRender();
            return t;
    ...
    k.button._ = {instances: [], keydown: function(l, m) {
            ...
            if (n.onfocus)
                o = n.onfocus(n, new d.event(m)) !== false;
    ...
    (function() {
        ...
        n.prototype = {exec: function(r, s) {
                var t = m(r, this.type);
                if (!t)
                    alert(r.lang.clipboard[this.type + 'Error']);
                return t;
            }};
        var o = {canUndo: false, exec: c ? function(r) {
                ...
                try {
                    if (!r.document.getBody().fire('beforepaste') && !r.document.$.execCommand('Paste', false, null))
                        throw 0;
                } catch (s) {
                    setTimeout(function() {
                        r.fire('pasteDialog');
        ...
        j.add('clipboard', {requires: ['dialog', 'htmldataprocessor'], init: function(r) {
                ...
                function s(w, x, y, z) {
                    ...
                    if (r.addMenuItems)
                        r.addMenuItem(x, {label: A, command: x, group: 'clipboard', order: z});
                }
                ;
    ...
    j.add('colorbutton', {requires: ['panelbutton', 'floatpanel', 'styles'], init: function(l) {
            ...
            function q(r, s) {
                ...
                if (m.colorButton_enableMore)
                    t.push('</tr><tr><td colspan=8 align=center><a class="cke_colormore" _cke_focus=1 hidefocus=true title="', n.more, '" onclick="CKEDITOR.tools.callFunction(', w, ",'?','", s, "');return false;\" href=\"javascript:void('", n.more, "')\"", ' role="option" aria-posinset="', v, '" aria-setsize="', v, '">', n.more, '</a></td>');
                t.push('</tr></table>');
                return t.join('');
            }
            ;
            ...
            this.definition = {panel: {className: l.skinClass + ' cke_contextmenu', attributes: {'aria-label': l.lang.contextmenu.options}}};
                ...
                if (b.opera) {
                    ...
                    l.on('mousedown', function(r) {
                        r = r.data;
                        if (r.$.button != 2) {
                            if (r.getKeystroke() == 1000 + 1)
                                l.fire('contextmenu', r);
                            return;
                        }
                        if (m && (r.$.ctrlKey || r.$.metaKey))
                            return;
                        var s = r.getTarget();
                        if (!n) {
                            var t = s.getDocument();
                ...
                l.on('contextmenu', function(r) {
                    var s = r.data;
                    if (m && (b.webkit ? o : s.$.ctrlKey || s.$.metaKey))
                        return;
                    if (c) {
    ...
    (function() {
        ...
        j.add('elementspath', {requires: ['selection'], init: function(n) {
                var o = 'cke_path_' + n.name, p, q = function() {
                    if (!p)
                        p = a.document.getById(o);
                    return p;
                }, r = 'cke_elementspath_' + e.getNextNumber() + '_';
                n._.elementsPath = {idBase: r, filters: []};
                n.on('themeSpace', function(s) {
                    if (s.data.space == 'bottom')
                        s.data.html += '<span id="' + o + '_label" class="cke_voice_label">' + n.lang.elementsPath.eleLabel + '</span>' + '<div id="' + o + '" class="cke_path" role="group" aria-labelledby="' + o + '_label">' + m + '</div>';
                });
                n.on('selectionChange', function(s) {
                    ...
                    while (v) {
                        ...
                        if (!A) {
                            var C = y.push(v) - 1, D;
                            if (v.getAttribute('_cke_real_element_type'))
                                D = v.getAttribute('_cke_real_element_type');
                            else
                                D = v.getName();
                            var E = '';
                            ...
                            if (t.gecko)
                                E += ' onblur="this.style.cssText = this.style.cssText;"';
    ...
    a._.elementsPath = {click: function(l, m) {
            ...
            switch (n.getKeystroke()) {
                ...
                case 2000 + 9:
                    r = a.document.getById(q + (m - 1));
                    if (!r)
                        r = a.document.getById(q + (p._.elementsPath.list.length - 1));
                    r.focus();
                    return false;
                case 27:
                    p.focus();
    ...
    (function() {
        ...
        j.enterkey = {enterBlock: function(s, t, u, v) {
                ...
                if (!D && !E) {
                    if (C.is('li') && (F = C.getFirst(d.walker.invisible(true))) && F.is && F.is('ul', 'ol'))
                        (c ? w.createText('\xa0') : w.createElement('br')).insertBefore(F);
                    if (C)
                        u.moveToElementEditStart(C);
                } else {
                    var G;
                    if (B) {
                        if (B.is('li') || !(v || o.test(B.getName())))
                            G = B.clone();
                    } else if (C)
                        G = C.clone();
                    if (!G)
                    ...
                    if (H)
                        for (var I = 0, J = H.elements.length; I < J; I++) {
                            var K = H.elements[I];
                            if (K.equals(H.block) || K.equals(H.blockLimit))
                                break;
                ...
                if (!v && y && o.test(B)) {
                    ...
                    u.insertNode(D);
                    if (!c)
                        w.createText(' ').insertAfter(D);
                    if (y && !c)
                        D.getParent().appendBogus();
                    if (!c)
                        D.getNext().$.nodeValue = '';
                    if (c)
                        u.setStartAt(D, 4);
                    else
                        u.setStartAt(D.getNext(), 1);
                    if (!c) {
                        var E = null;
                        if (!b.gecko) {
        ...
        function q(s, t, u) {
            ...
            if (s.mode != 'wysiwyg')
                return false;
            if (!t)
                t = s.config.enterMode;
            setTimeout(function() {
                s.fire('saveSnapshot');
                if (t == 2 || s.getSelection().getStartElement().hasAscendant('pre', true))
                    m(s, t, null, u);
                else
                    n(s, t, null, u);
            }, 0);
    ...
    (function() {
        ...
        j.add('entities', {afterInit: function(p) {
                ...
                if (s) {
                    ...
                    if (q.entities_greek)
                        t += ',' + n;
                    if (q.entities_additional)
                        t += ',' + q.entities_additional;
                    var u = o(t), v = '[' + u.regex + ']';
                    delete u.regex;
                    if (q.entities_processNumerical)
                        v = '[^ -~]|' + v;
                    v = new RegExp(v, 'g');
                    function w(x) {
    ...
    (function() {
        function l(u, v) {
            ...
            if (!v)
                ...
                for (var x in v)
                    w.push(x + '=' + encodeURIComponent(v[x]));
        ...
        function o(u) {
            ...
            w._.filebrowserSe = x;
            if (!v.getContentElement(x['for'][0], x['for'][1]).getInputElement().$.value)
                return false;
            if (!v.getContentElement(x['for'][0], x['for'][1]).getAction())
                return false;
            return true;
        }
        ;
        ...
        function t(u, v) {
            ...
            if (x)
                w.getContentElement(x[0], x[1]).reset();
            if (typeof v == 'function' && v.call(z._.filebrowserSe) === false)
                return;
            if (y && y.call(z._.filebrowserSe, u, v) === false)
                return;
            if (typeof v == 'string' && v)
                alert(v);
            if (u)
                r(u, z._.filebrowserSe);
        }
        ;
        ...
        a.on('dialogDefinition', function(u) {
            ...
            for (var x in v.contents) {
                ...
                if (w.hidden && w.filebrowser)
                    w.hidden = !s(v, w.id, w.filebrowser);
            }
        });
    })();
        ...
        j.add('flash', {init: function(q) {
                ...
                if (q.contextMenu)
                    q.contextMenu.addListener(function(r, s) {
                        if (r && r.is('img') && r.getAttribute('_cke_real_element_type') == 'flash')
                            return{flash: 2};
                    });
                    ...
                    l.on('selectionChange', function(s) {
                        ...
                        for (var v in p) {
                            if (p[v].checkActive(u)) {
                                if (v != t)
                                    this.setValue(v, l.lang.format['tag_' + v]);
                                return;
                            }
                        }
                        this.setValue('');
            ...
            if (l.contextMenu) {
                ...
                l.contextMenu.addListener(function(p) {
                    if (p) {
                        ...
                        if (q == 'img' && p.getAttribute('_cke_real_element_type') == 'hiddenfield')
    ...
    (function() {
        ...
        function n(O) {
            ...
            while (Q && Q.type == 3 && !e.trim(Q.value))
                Q = O.children[--P];
            return Q;
        }
        ;
        function o(O, P) {
            ...
            if (R) {
                if ((P || !c) && R.type == 1 && R.name == 'br')
                    Q.pop();
                if (R.type == 3 && l.test(R.value))
                    Q.pop();
            }
        }
        ;
        ...
        function q(O) {
            ...
            if (p(O))
                if (c)
                    O.add(new a.htmlParser.text('\xa0'));
                else
                    O.add(new a.htmlParser.element('br', {}));
        }
        ;
        function r(O) {
            o(O);
        ...
        for (u in t)
            w.elements[u] = q;
        var x = {elementNames: [[/^cke:/, ''], [/^\?xml:namespace$/, '']], attributeNames: [[/^_cke_(saved|pa)_/, ''], [/^_cke.*/, ''], ['hidefocus', '']], elements: {$: function(O) {
                    var P = O.attributes;
                    if (P) {
                        if (P.cke_temp)
                            return false;
                    ...
                    if (!(O.children.length || O.attributes.name || O.attributes._cke_saved_name))
                        return false;
                }, body: function(O) {
                ...
                if (O.substr(0, m.length) == m) {
                    if (O.substr(m.length, 3) == '{C}')
                        O = O.substr(m.length + 3);
                    else
                        O = O.substr(m.length);
        ...
        for (u in t)
            y.elements[u] = r;
        if (c)
            x.attributes.style = function(O, P) {
    ...
    j.add('image', {init: function(l) {
            ...
            if (l.addMenuItems)
                l.addMenuItems({image: {label: l.lang.image.menu, command: 'image', group: 'image'}});
            if (l.contextMenu)
                l.contextMenu.addListener(function(n, o) {
                    if (!n || !n.is('img') || n.getAttribute('_cke_realelement'))
                        return null;
                    return{image: 2};
                });
        }});
    ...
    (function() {
        ...
        function n(r) {
            ...
            if (C.useIndentClasses) {
                ...
                if (C.name == 'outdent' && !A || C.name == 'indent' && A == v.config.indentClasses.length)
                    return m.call(C, v, 0);
                return m.call(C, v, 2);
            } else {
        ...
        function o(r, s, t) {
            ...
            while (u && !u.getParent().equals(t))
                u = u.getParent();
            while (v && !v.getParent().equals(t))
                v = v.getParent();
            if (!u || !v)
                return;
            var w = u, x = [], y = false;
            ...
            for (A = D.getCustomData('listarray_index') + 1; A < F.length && F[A].indent > G; A++)
                F[A].indent += B;
            ...
            if (this.name == 'outdent') {
                ...
                if ((J = t.getParent()) && J.is('li')) {
                    ...
                    for (A = M - 1; A >= 0; A--) {
                        if ((N = K.getItem(A)) && N.is && N.is('li'))
                            L.push(N);
                    }
                }
            }
            if (I)
                I.listNode.replace(t);
            if (L && L.length)
                for (A = 0; A < L.length; A++) {
                    var O = L[A], P = O;
                    while ((P = P.getNext()) && P.is && P.getName() in l)
                        O.append(P);
                    O.insertAfter(J);
                }
            h.clearAllMarkers(E);
            ...
            while (v = t.getNextParagraph()) {
                if (A.useIndentClasses) {
                    ...
                    if (x < 1)
                        ...
                        v.$.className = e.ltrim(y + ' ' + r.config.indentClasses[x - 1]);
                } else {
        ...
        function q(r, s) {
            ...
            if (u.useIndentClasses) {
                ...
                u.indentClassMap = {};
                for (var t = 0; t < r.config.indentClasses.length; t++)
                    u.indentClassMap[r.config.indentClasses[t]] = t + 1;
            } else
                u.indentCssProperty = r.config.contentsLangDirection == 'ltr' ? 'margin-left' : 'margin-right';
    ...
    (function() {
        ...
        function m(p, q) {
            ...
            if (!s && this.isDefaultAlign || s == this.value)
                return 1;
            return 2;
        }
        ;
                ...
                for (var x = t.length - 1; x >= 0; x--) {
                    ...
                    while (w = v.getNextParagraph()) {
                        ...
                        if (u) {
                            ...
                            if (z.state == 2 && !z.isDefaultAlign)
                                w.addClass(u);
                            else if (!y)
                                w.removeAttribute('class');
                        } else if (z.state == 2 && !z.isDefaultAlign)
                            w.setStyle('text-align', z.value);
                        else
    ...
    a.keystrokeHandler = function(l) {
        var m = this;
        if (l.keystrokeHandler)
            return l.keystrokeHandler;
        m.keystrokes = {};
        m.blockedKeystrokes = {};
        m._ = {editor: l};
        return m;
    ...
    j.add('link', {init: function(l) {
            ...
            l.on('selectionChange', function(m) {
                ...
                if (o && o.getName() == 'a' && o.getAttribute('href'))
                    n.setState(2);
                else
                    n.setState(0);
            });
            if (l.addMenuItems)
                l.addMenuItems({anchor: {label: l.lang.anchor.menu, command: 'anchor', group: 'anchor'}, link: {label: l.lang.link.menu, command: 'link', group: 'link', order: 1}, unlink: {label: l.lang.unlink, command: 'unlink', group: 'link', order: 5}});
            if (l.contextMenu)
            ...
            if (n)
                n.addRules({elements: {a: function(o) {
                            var p = o.attributes;
                            if (p.name && !p.href)
                                return l.createFakeParserElement(o, 'cke_anchor', 'anchor');
                        }}});
        }, requires: ['fakeobjects']});
    ...
    (function() {
        ...
        j.list = {listToArray: function(A, B, C, D, E) {
                ...
                for (var F = 0, G = A.getChildCount(); F < G; F++) {
                    ...
                    if (!E) {
                        ...
                        I.grandparent = E;
                    if (B)
                        h.setMarker(B, H, 'listarray_index', C.length);
                    C.push(I);
                    for (var J = 0, K = H.getChildCount(), L; J < K; J++) {
                        L = H.getChild(J);
                        if (L.type == 1 && l[L.getName()])
                            j.list.listToArray(L, B, C, D + 1, I.grandparent);
                        else
                            I.contents.push(L);
                    }
                }
                ...
                for (; ; ) {
                    ...
                    if (L.indent == I) {
                        ...
                        for (var M = 0; M < L.contents.length; M++)
                            J.append(L.contents[M].clone(true, true));
                        H++;
                        ...
                        J;
                        if (l[L.grandparent.getName()])
                            J = L.element.clone(false, true);
                        else if (D != 2 && L.grandparent.getName() != 'td')
                            J = E.createElement(K);
                        else
                            J = new d.documentFragment(E);
                        for (M = 0; M < L.contents.length; M++)
                            J.append(L.contents[M].clone(true, true));
                        if (J.type == 11 && H != A.length - 1) {
                            if (J.getLast() && J.getLast().type == 1 && J.getLast().getAttribute('type') == '_moz')
                                J.getLast().remove();
                            J.appendBogus();
                        }
                        ...
                        return null;
                    if (A.length <= H || Math.max(A[H].indent, 0) < I)
                        break;
                }
                if (B) {
                    var R = F.getFirst();
        ...
        function o(A) {
            ...
            for (var F = 0; F < D.length && (E = D[F]) && !E.equals(C); F++) {
                if (l[D[F].getName()])
                    return n.call(this, A.editor, this.type == D[F].getName() ? 1 : 2);
            }
        ...
        function p(A, B, C, D) {
            ...
            for (var G = 0; G < B.contents.length; G++) {
                ...
                if (!H || H.getCustomData('list_item_processed'))
                    continue;
                F.push(H);
        ...
        function q(A, B, C) {
            ...
            for (var I = 0; I < D.length; I++)
                H = H.getCommonAncestor(D[I].getParent());
        ...
        function r(A, B, C) {
            ...
            for (var F = 0; F < B.contents.length; F++) {
                ...
                if (!G || G.getCustomData('list_item_processed'))
                    continue;
                E.push(G);
            ...
            function P(Q) {
                if ((N = M[Q ? 'getFirst' : 'getLast']()) && !(N.is && N.isBlockBoundary()) && (O = B.root[Q ? 'getPrevious' : 'getNext'](d.walker.whitespaces(true))) && !(O.is && O.isBlockBoundary({br: 1})))
        ...
        s.prototype = {exec: function(A) {
                ...
                if (this.state == 2) {
                    ...
                    if (!E.getFirst()) {
                        ...
                        if (F.is('br')) {
                            ...
                            D[0].selectNodeContents(F);
                        C.selectRanges(D);
                    } else {
                        var G = D.length == 1 && D[0], H = G && G.getEnclosedNode();
                        if (H && H.is && this.type == H.getName())
                            n.call(this, A, 1);
                    }
                }
                ...
                while (D.length > 0) {
                    ...
                    if (M.type == 1 && M.getName() == 'td')
                        G.setStartAt(L.startNode, 1);
                    if (N.type == 1 && N.getName() == 'td')
                        G.setEndAt(L.endNode, 2);
                    ...
                    while (P = O.getNextParagraph()) {
                        ...
                        if (U)
                            continue;
                        var Z = V;
                        if (Z.getCustomData('list_group_object'))
                            Z.getCustomData('list_group_object').contents.push(P);
                        else {
                            Y = {root: Z, contents: [P]};
                ...
                while (J.length > 0) {
                    ...
                    if (this.state == 2) {
                        if (l[Y.root.getName()])
                            p.call(this, A, Y, K, aa);
                        else
                            q.call(this, A, Y, aa);
                    } else if (this.state == 1 && l[Y.root.getName()])
                        r.call(this, A, Y, K);
                }
        ...
        function w(A) {
            return function(B) {
                ...
                if (F && (F.name && F.name == 'br' || F.value && (G = F.value.match(u)))) {
                    var H = F;
                    if (!(G && G.index) && H == C[0])
                        C[0] = A || c ? new a.htmlParser.text('\xa0') : new a.htmlParser.element('br', {});
                    else if (H.name == 'br')
                        C.splice(D - 1, 1);
                    else
                        H.value = H.value.replace(u, '');
                }
            };
        }
        ;
        var x = {elements: {}};
        for (var y in t.$listItem)
            x.elements[y] = w();
        var z = {elements: {}};
        for (y in t.$listItem)
            z.elements[y] = w(true);
    ...
    (function() {
        ...
        function n(r, s) {
            ...
            if (!s)
                v.style.cssText = 'position: static; overflow: visible';
            m(t);
            return u;
        }
        ;
        ...
        j.add('maximize', {init: function(r) {
                ...
                r.addCommand('maximize', {modes: {wysiwyg: 1, source: 1}, editorFocus: false, exec: function() {
                        ...
                        if (this.state == 2) {
                            ...
                            if (c)
                                t.$.documentElement.style.overflow = t.getBody().$.style.overflow = 'hidden';
                            else
                                t.getBody().setStyles({overflow: 'hidden', width: '0px', height: '0px'});
    ...
    j.add('pagebreak', {init: function(l) {
            ...
            var m = l.dataProcessor, n = m && m.dataFilter;
            if (n)
                n.addRules({elements: {div: function(o) {
                            ...
                            if (s && /page-break-after\s*:\s*always/i.test(q) && /display\s*:\s*none/i.test(s))
                                return l.createFakeParserElement(o, 'cke_pagebreak', 'div');
                        }}});
        }, requires: ['fakeobjects']});
                ...
                l.on('paste', function(o) {
                    ...
                    if ((q = p.html) && (m || /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(q))) {
                        var r = this.loadFilterRules(function() {
                            if (r)
                                l.fire('paste', p);
                            else if (!l.config.pasteFromWordPromptCleanup || m || confirm(l.lang.pastefromword.confirmCleanup))
                                p.html = a.cleanWord(q, l);
                        });
                        r && o.cancel();
                    }
                }, this);
    ...
    (function() {
        ...
        function m(o, p) {
            if (c) {
                ...
                o.execCommand('inserthtml', false, p);
        }
        ;
        ...
        function n(o, p, q, r) {
            while (q--)
                j.enterkey[p == 2 ? 'enterBr' : 'enterBlock'](o, p, null, r);
        }
        ;
    ...
    (function() {
        var l = {modes: {wysiwyg: 1, source: 1}, canUndo: false, exec: function(n) {
                ...
                if (p.fullPage)
                    o = n.getData().replace(/<head>/, '$&' + q).replace(/[^>]*(?=<\/title>)/, n.lang.preview);
                else {
                    ...
                    for (var p = 0, q; q = o[p]; p++) {
                        ...
                        var r = q.createBookmark(), s = r.startNode, t = r.endNode, u = function(x) {
                            ...
                            for (var A = 1, B; B = z[A]; A++) {
                                if (B.equals(y.block) || B.equals(y.blockLimit))
                                    break;
                                if (m.test(B.getName()))
                                    x.breakParent(B);
                            }
    ...
    j.add('resize', {init: function(l) {
            ...
            if (m.resize_enabled) {
                ...
                l.on('themeSpace', function(t) {
                    if (t.data.space == 'bottom')
                        t.data.html += '<div class="cke_resizer" title="' + e.htmlEncode(l.lang.resize) + '"' + ' onmousedown="CKEDITOR.tools.callFunction(' + s + ', event)"' + '></div>';
                }, l, null, 100);
            }
        }});
    ...
    (function() {
        ...
        var q = function() {
            var u = this, v = function() {
                ...
                for (var G = 0, H = 4; G < H; G++)
                    F.push(E[G] && r.uiTabs[G]);
                r.uiTabs = F;
                try {
            ...
            if (x)
                x.addRules({elements: {span: function(y) {
        ...
        j.scayt = {engineLoaded: false, instances: {}, getScayt: function(u) {
                ...
                var v;
                if (u.match && (v = u.match(/(.*)[\/\\](.*?\.\w+)$/)))
                    return{path: v[1], file: v[2]};
                else
                    return u;
            }};
        ...
        j.add('scayt', {requires: ['menubutton'], beforeInit: function(u) {
                ...
                if (z[0] == 1)
                    E.scaytOptions = {label: u.lang.scayt.options, group: D, onClick: function() {
                            m = 'options';
                            u.openDialog(l);
                        }};
                if (z[1] == 1)
                    E.scaytLangs = {label: u.lang.scayt.langs, group: D, onClick: function() {
                            m = 'langs';
                            u.openDialog(l);
                        }};
                if (z[2] == 1)
                    E.scaytDict = {label: u.lang.scayt.dictionariesTab, group: D, onClick: function() {
                            m = 'dictionaries';
                            u.openDialog(l);
                        }};
                ...
                if (u.contextMenu && u.addMenuItems)
                ...
                var v;
                if (u._.elementsPath && (v = u._.elementsPath.filters))
                    v.push(function(w) {
                        if (w.hasAttribute('scaytid'))
                            return false;
                    });
            }});
    })();
    ...
    (function() {
        ...
        j.add('showblocks', {requires: ['wysiwygarea'], init: function(p) {
                ...
                q.canUndo = false;
                if (p.config.startupOutlineBlocks)
                    q.setState(1);
    ...
    (function() {
        ...
        j.add('showborders', {requires: ['wysiwygarea'], modes: {wysiwyg: 1}, init: function(p) {
                ...
                q.canUndo = false;
                if (p.config.startupShowBorders !== false)
                    q.setState(1);
                p.addCss(m);
                p.on('mode', function() {
                    if (q.state != 0)
                ...
                if (r)
                    r.addRules({elements: {table: function(t) {
                                var u = t.attributes, v = u['class'], w = parseInt(u.border, 10);
                                if (!w || w <= 0)
                                    u['class'] = (v || '') + ' ' + l;
                            }}});
                if (s)
                    s.addRules({elements: {table: function(t) {
    ...
    j.add('sourcearea', {requires: ['editingblock'], init: function(l) {
            ...
            if (l.ui.addButton)
                l.ui.addButton('Source', {label: l.lang.source, command: 'source'});
            l.on('mode', function() {
    ...
    (function() {
        j.add('stylescombo', {requires: ['richcombo', 'styles'], init: function(m) {
                ...
                m.ui.addRichCombo('Styles', {label: o.label, title: o.panelTitle, className: 'cke_styles', panel: {css: m.skin.editor.css.concat(n.contentsCss), multiSelect: true, attributes: {'aria-label': o.panelTitle}}, init: function() {
                        ...
                        if (!v[1])
                            z.hideGroup(o['panelTitle' + String(1)]);
                        if (!v[2])
                            z.hideGroup(o['panelTitle' + String(2)]);
                        if (!v[3])
                            z.hideGroup(o['panelTitle' + String(3)]);
                    }});
    ...
    j.add('table', {init: function(l) {
            ...
            if (l.addMenuItems)
                l.addMenuItems({table: {label: n.menu, command: 'tableProperties', group: 'table', order: 5}, tabledelete: {label: n.deleteTable, command: 'tableDelete', group: 'table', order: 1}});
            if (l.contextMenu)
    ...
    (function() {
        ...
        function o(F) {
            ...
            while (J = F[G++])
                h.setMarker(I, J, 'delete_cell', true);
            G = 0;
            while (J = F[G++]) {
        ...
        function B(F, G, H) {
            var I = n(F), J;
            if ((G ? I.length != 1 : I.length < 2) || (J = F.getCommonAncestor()) && J.type == 1 && J.is('table'))
                return false;
        ...
        j.tabletools = {init: function(F) {
                ...
                F.addCommand('tableDelete', {exec: function(H) {
                        ...
                        L.collapse();
                        I.selectRanges([L]);
                        if (K.getParent().getChildCount() == 1)
                            K.getParent().remove();
                        else
                            K.remove();
                    }});
                ...
                if (F.addMenuItems)
                    F.addMenuItems({tablecell: {label: G.cell.menu, group: 'tablecell', order: 1, getItems: function() {
                ...
                if (F.contextMenu)
                    F.contextMenu.addListener(function(H, I) {
                        if (!H)
                            return null;
                        while (H) {
                            if (H.getName() in E)
            ...
            while (t = t.getNextSourceNode(false, 1)) {
                if (!p)
                    if (!q && t.equals(v)) {
                        q = true;
                        if (l) {
                            if (!(t = t.getNextSourceNode(true, 1)))
                                break;
                            p = 1;
                        }
                    } else if (q && !v.contains(t))
                        p = 1;
                if (!t.isVisible() || (u = t.getTabIndex()) < 0)
                    continue;
                if (p && u == o) {
                    r = t;
                    break;
        ...
        while (u = u.getPreviousSourceNode(false, 1)) {
            if (!p)
                if (!q && u.equals(v)) {
                    q = true;
                    if (l) {
                        if (!(u = u.getPreviousSourceNode(true, 1)))
                            break;
                        p = 1;
                    }
                } else if (q && !v.contains(u))
                    p = 1;
            if (!u.isVisible() || (t = u.getTabIndex()) < 0)
                continue;
            if (o <= 0) {
                if (p && t === 0) {
                    r = u;
                        ...
                        for (var w = 0; w < v.length; w++) {
                            ...
                            for (var B = 0; B < x.length; B++) {
                                ...
                                if (C) {
                                    ...
                                    E.onkey = o;
                                    E.onfocus = function() {
                                        if (!n.toolbox.focusCommandExecuted)
                                            n.focus();
                                    };
                                }
                            }
    ...
    (function() {
        j.add('undo', {requires: ['selection', 'wysiwygarea'], init: function(r) {
                ...
                function v(w) {
                    if (s.enabled && w.data.command.canUndo !== false)
                        s.save();
                }
                ;
                ...
                r.on('contentDom', function() {
                    r.document.on('keydown', function(w) {
                        if (!w.data.$.ctrlKey && !w.data.$.metaKey)
                            s.type(w);
                    });
                });
        ...
        l.prototype = {equals: function(r, s) {
                ...
                if (v || w) {
                    if (!v || !w || v.length != w.length)
                        return false;
                    for (var x = 0; x < v.length; x++) {
                        var y = v[x], z = w[x];
                        if (y.startOffset != z.startOffset || y.endOffset != z.endOffset || !e.arrayCompare(y.start, z.start) || !e.arrayCompare(y.end, z.end))
                            return false;
                    }
                }
                return true;
        ...
        n.prototype = {type: function(r) {
                ...
                if (B || A) {
                    ...
                    e.setTimeout(function() {
                        ...
                        if (c)
                            D = D.replace(/\s+_cke_expando=".*?"/g, '');
                        if (C.contents != D) {
                            E.typing = true;
                            if (!E.save(false, C, false))
                                E.snapshots.splice(E.index + 1, E.snapshots.length - E.index - 1);
                            E.hasUndo = true;
                            E.hasRedo = false;
                            E.typesCount = 1;
                            E.modifiersCount = 1;
                ...
                if (s.contents === false)
                    return false;
                if (v.currentImage && s.equals(v.currentImage, r))
                    return false;
                ...
                if (r.bookmarks)
                    t.editor.getSelection().selectBookmarks(r.bookmarks);
                else if (c) {
        ...
        function n(w) {
            if (this.mode == 'wysiwyg') {
                ...
                if (c) {
                    ...
                    this.document.$.execCommand('inserthtml', false, y);
                e.setTimeout(function() {
                    this.fire('saveSnapshot');
                }, 0, this);
            }
        ...
        function v(w) {
            ...
            if (D != 2 && B.collapsed && z.getName() == 'body' && !y.block) {
                ...
                if (E.getOuterHtml().match(m)) {
                    ...
                    if (G && G.getName && !(G.getName() in l) && B.moveToElementEditStart(G) || H && H.getName && !(H.getName() in l) && B.moveToElementEditStart(H))
                        E.remove();
                }
                B.select();
                if (!c)
        ...
        j.add('wysiwygarea', {requires: ['editingblock'], init: function(w) {
                ...
                w.on('editingBlockReady', function() {
                    var B, C, D, E, F, G, H = b.isCustomDomain(), I = function(L) {
                        ...
                        if (!(c || b.opera))
                            M.on('mousedown', function(V) {
                                var W = V.data.getTarget();
                                if (W.is('img', 'hr', 'input', 'textarea', 'select'))
                                    w.getSelection().selectElement(W);
                            });
                        if (b.webkit) {
                            M.on('click', function(V) {
                                if (V.data.getTarget().is('input', 'select'))
                                    V.data.preventDefault();
                            });
                            M.on('mouseup', function(V) {
                                if (V.data.getTarget().is('input', 'textarea'))
                                    V.data.preventDefault();
                            });
                        }
                        ...
                        Q.on('focus', function() {
                            if (b.gecko) {
                                ...
                                if (!V.nextSibling && 'BR' == V.tagName && V.hasAttribute('_moz_editor_bogus_node')) {
                                    ...
                                    if (w.config.enterMode == 2)
                                        M.createElement('br', {attributes: {_moz_dirty: ''}}).replace(X);
                                    else
                                        X.remove();
                                }
                            }
                        ...
                        if (w.contextMenu)
                            w.contextMenu.addTarget(M, w.config.browserContextMenuOnCtrl !== false);
                        setTimeout(function() {
                            w.fire('contentDom');
                            if (G) {
                                w.mode = 'wysiwyg';
                    ...
                    w.addMode('wysiwyg', {load: function(L, M, N) {
                            ...
                            if (N)
                                L = L.replace(/<!DOCTYPE[^>]*>/i, function(R) {
                                    w.docType = O = R;
                                    return '';
                                });
                            if (w.dataProcessor)
                                L = w.dataProcessor.toHtml(L, x);
                            if (N) {
                                if (!/<body[\s|>]/.test(L))
                                    L = '<body>' + L;
                                if (!/<html[\s|>]/.test(L))
                                    L = '<html>' + L + '</html>';
                                if (!/<head[\s|>]/.test(L))
                                    L = L.replace(/<html[^>]*>/, '$&<head><title></title></head>');
                                Q && (L = L.replace(/<head>/, '$&' + Q));
                                L = L.replace(/<\/head\s*>/, P + '$&');
                                L = O + L;
                            } else
                                L = M.docType + '<html dir="' + M.contentsLangDirection + '">' + '<title>' + y + '</title>' + '<head>' + Q + P + '</head>' + '<body' + (M.bodyId ? ' id="' + M.bodyId + '"' : '') + (M.bodyClass ? ' class="' + M.bodyClass + '"' : '') + '>' + L + '</html>';
                            L += J;
                            ...
                            if (w.dataProcessor)
                                P = w.dataProcessor.toDataFormat(P, x);
                            if (L.ignoreEmptyParagraph)
                                P = P.replace(m, '');
                            if (N)
                                P = N + '\n' + P;
                            return P;
        ...
        if (b.gecko)
            (function() {
                ...
                if (!w)
                    ...
                    w.setAttribute('onpageshow', w.getAttribute('onpageshow') + ';event.persisted && CKEDITOR.tools.callFunction(' + e.addFunction(function() {
    ...
    (function() {
        ...
        function m() {
            ...
            for (var N = M - 1; N > M - L; N--) {
                if (l.call(O, O._.tabIdList[N % L]))
                    return O._.tabIdList[N % L];
            }
            return null;
        }
        ;
        ...
        a.dialog = function(K, L) {
            ...
            if (M.onOk)
                this.on('ok', function(aa) {
                    if (M.onOk.call(this, aa) === false)
                        aa.data.hide = false;
                });
            if (M.onCancel)
                this.on('cancel', function(aa) {
                    if (M.onCancel.call(this, aa) === false)
                        aa.data.hide = false;
                });
            ...
            this.on('cancel', function(aa) {
                Q(function(ab) {
                    if (ab.isChanged()) {
                        if (!confirm(K.lang.common.confirmCancel))
                            aa.data.hide = false;
                        return true;
                    }
                });
            ...
            function R() {
                ...
                aa.sort(function(ad, ae) {
                    if (ad.tabIndex != ae.tabIndex)
                        return ae.tabIndex - ad.tabIndex;
                    else
                        return ad.focusIndex - ae.focusIndex;
                });
                var ab = aa.length;
            ...
            for (var X = 0; X < M.contents.length; X++)
                this.addPage(M.contents[X]);
        ...
        function o(K, L, M) {
            ...
            L.on('keydown', function(N) {
                if (N.data.getKeystroke() in {32: 1, 13: 1})
                    this.fire('click');
            });
            L.on('focus', function() {
                this.fire('mouseover');
        ...
        a.dialog.prototype = {resize: (function() {
                return function(K, L) {
                    var M = this;
                    if (M._.contentSize && M._.contentSize.width == K && M._.contentSize.height == L)
                        return;
                ...
                return function(L, M) {
                    ...
                    if (K === undefined)
                        K = N.getComputedStyle('position') == 'fixed';
                    if (K && P._.position && P._.position.x == L && P._.position.y == M)
                        return;
                ...
                if (!(M.getParent() && M.getParent().equals(a.document.getBody())))
                    M.appendTo(a.document.getBody());
                else
                    return;
                if (b.gecko && b.version < 10900) {
                ...
                if (a.dialog._.currentTop === null) {
                    ...
                    for (var P in {keyup:1, keydown:1, keypress:1})
                        M.on(P, J);
                } else {
                ...
                if (!this._.parentDialog) {
                    ...
                    for (var M in {keyup:1, keydown:1, keypress:1})
                ...
                while (U = V.shift()) {
                    T[U.id] = U;
                    if (typeof U.getChild == 'function')
                        V.push.apply(V, U.getChild());
                }
                ...
                if (!L || M._.pageCount == 1)
                    return;
                else if (K == M._.currentTabId)
                    M.selectPage(m.call(M));
                L.hide();
                M._.pageCount--;
                M.updateStyle();
            }, showPage: function(K) {
                ...
                if (typeof L == 'undefined') {
                    ...
                    for (var M = L + 1; M < N._.focusList.length; M++)
                        N._.focusList[M].focusIndex++;
                }
            }};
        e.extend(a.dialog, {add: function(K, L) {
                if (!this._.dialogDefinitions[K] || typeof L == 'function')
                    this._.dialogDefinitions[K] = L;
            }, exists: function(K) {
                ...
                var K = function(L, M) {
                    ...
                    return e.extend({id: 'ok', type: 'button', label: L.lang.common.ok, 'class': 'cke_dialog_ui_button_ok', onClick: function(N) {
                            var O = N.data.dialog;
                            if (O.fire('ok', {hide: true}).hide !== false)
                                O.hide();
                        }}, M, true);
                };
                K.type = 'button';
                ...
                var K = function(L, M) {
                    ...
                    return e.extend({id: 'cancel', type: 'button', label: L.lang.common.cancel, 'class': 'cke_dialog_ui_button_cancel', onClick: function(N) {
                            var O = N.data.dialog;
                            if (O.fire('cancel', {hide: true}).hide !== false)
                                O.hide();
                        }}, M, true);
                };
                K.type = 'button';
        ...
        function v(K) {
            ...
            function R(T) {
                ...
                if (M.x + Q[3] < P)
                    aa = -Q[3];
                else if (M.x - Q[1] > V.width - U.width - P)
                    aa = V.width - U.width + Q[1];
                else
                    aa = M.x;
                if (M.y + Q[0] < P)
                    ab = -Q[0];
                else if (M.y - Q[2] > V.height - U.height - P)
                    ab = V.height - U.height + Q[2];
                else
                    ab = M.y;
                K.move(aa, ab);
        ...
        function w(K) {
            ...
            function Z(ab) {
                ...
                if (V.x + P[3] < W)
                    ai = -P[3];
                else if (ah.search('l') != -1 && V.x2 - V.x < M + W)
                    ai = V.x2 - M;
                else
                    ai = V.x;
                if (V.y + P[0] < W)
                    aj = -P[0];
                else if (ah.search('t') != -1 && V.y2 - V.y < N + W)
                    aj = V.y2 - N;
                else
                    aj = V.y;
                if (V.x2 - P[1] > ag.width - W)
                    ak = ag.width + P[1];
                else if (ah.search('r') != -1 && V.x2 - V.x < M + W)
                    ak = V.x + M;
                else
                    ak = V.x2;
                if (V.y2 - P[2] > ag.height - W)
                    al = ag.height + P[2];
                else if (ah.search('b') != -1 && V.y2 - V.y < N + W)
                    al = V.y + N;
                else
                    al = V.y2;
                K.move(ai, aj);
        ...
        var x, y, z = function(K) {
            ...
            for (var L in B) {
                ...
                for (var N = M.length - 1; N >= 0; N--) {
                    if (M[N].dialog == K || M[N].uiElement == K)
                        M.splice(N, 1);
                }
                if (M.length === 0)
                    delete B[L];
            ...
            if (K._.accessKeyMap[L])
                K.selectPage(K._.accessKeyMap[L]);
        }, H = function(K, L) {
        }, I = {27: 1, 13: 1}, J = function(K) {
            if (K.data.getKeystroke() in I)
                K.data.stopPropagation();
        };
        (function() {
            k.dialog = {uiElement: function(K, L, M, N, O, P, Q) {
                    ...
                    for (Y in T)
                        ac.push(Y + ':' + T[Y]);
                    if (L.hidden)
                        ac.push('display:none');
                    for (Y = ac.length - 1; Y >= 0; Y--) {
                        if (ac[Y] === '')
                            ac.splice(Y, 1);
                    }
                    if (ac.length > 0)
                        U.style = (U.style ? U.style + '; ' : '') + ac.join('; ');
                    for (Y in U)
                        S.push(Y + '="' + e.htmlEncode(U[Y]) + '" ');
                    S.push('>', V, '</', R, '>');
                    M.push(S.join(''));
                    (this._ || (this._ = {})).dialog = K;
                    if (typeof L.isChanged == 'boolean')
                        this.isChanged = function() {
                            return L.isChanged;
                        };
                    if (typeof L.isChanged == 'function')
                        this.isChanged = L.isChanged;
                    a.event.implementOn(this);
                    this.registerEvents(L);
                    if (this.accessKeyUp && this.accessKeyDown && L.accessKey)
                        E(this, K, 'CTRL+' + L.accessKey);
                    var ad = this;
                    K.on('load', function() {
                    ...
                    var P = this._.children = L, Q = O && O.widths || null, R = O && O.height || null, S = {}, T, U = function() {
                        ...
                        for (T = 0; T < M.length; T++) {
                            ...
                            if (T === 0)
                                X = 'cke_dialog_ui_hbox_first';
                            if (T == M.length - 1)
                                X = 'cke_dialog_ui_hbox_last';
                            W.push('<td class="', X, '" role="presentation" ');
                            if (Q) {
                                if (Q[T])
                                    Y.push('width:' + e.cssLength(Q[T]));
                            } else
                                Y.push('width:' + Math.floor(100 / M.length) + '%');
                            if (R)
                                Y.push('height:' + e.cssLength(R));
                            if (O && O.padding != undefined)
                                Y.push('padding:' + e.cssLength(O.padding));
                            if (Y.length > 0)
                                W.push('style="' + Y.join('; ') + '" ');
                            W.push('>', M[T], '</td>');
                        }
                    ...
                    var P = this._.children = L, Q = O && O.width || null, R = O && O.heights || null, S = function() {
                        ...
                        for (var U = 0; U < M.length; U++) {
                            ...
                            if (Q)
                                V.push('width:' + e.cssLength(Q || '100%'));
                            if (R)
                                V.push('height:' + e.cssLength(R[U]));
                            else if (O && O.expand)
                                V.push('height:' + Math.floor(100 / M.length) + '%');
                            if (O && O.padding != undefined)
                                V.push('padding:' + e.cssLength(O.padding));
                            if (V.length > 0)
                                T.push('style="', V.join('; '), '" ');
        ...
        k.dialog.uiElement.prototype = {getElement: function() {
                ...
                if (N._.dialog._.currentTabId != M)
                    N._.dialog.selectPage(M);
                return N;
            }, focus: function() {
                ...
                for (var O in K) {
                    if (!(M = O.match(L)))
                        continue;
                    if (this.eventProcessors[O])
                        this.eventProcessors[O].call(this, this._.dialog, K[O]);
                    else
                        N(this, this._.dialog, M[1].toLowerCase(), K[O]);
                }
                return this;
        ...
        k.dialog.hbox.prototype = e.extend(new k.dialog.uiElement(), {getChild: function(K) {
                ...
                if (arguments.length < 1)
                    return L._.children.concat();
                if (!K.splice)
                    K = [K];
                if (K.length < 2)
                    return L._.children[K[0]];
                else
                    return L._.children[K[0]] && L._.children[K[0]].getChild ? L._.children[K[0]].getChild(K.slice(1, K.length)) : null;
            }}, true);
        ...
        (function() {
            ...
            a.dialog.validate = {functions: function() {
                    return function() {
                        ...
                        if (R < arguments.length && typeof arguments[R] == 'number')
                            P = arguments[R];
    ...
    e.extend(a.editor.prototype, {openDialog: function(l, m) {
            ...
            function u(w) {
                ...
                if (!y._isLoaded || v && typeof w == 'undefined')
                    return;
                if (typeof x != 'function')
                    a.dialog._.dialogDefinitions[l] = 'failed';
                t.openDialog(l, m);
                r.setStyle('cursor', s);
            }
            ;
    ...
    (function() {
        ...
        a.style.prototype = {apply: function(P) {
                    ...
                    case 2:
                        ...
                        for (var R = 0, S; R < Q.length; R++) {
                            ...
                            if (T.type == 2 && (S == P.block || S == P.blockLimit))
                                continue;
                            if (T.type == 3 && !(S.getName() in m))
                                continue;
                            if (T.checkElementRemovable(S, true))
                                return true;
                        }
                }
                return false;
                ...
                if (V) {
                    ...
                    for (var W = 0; W < S.length; W++) {
                        ...
                        if (X) {
                            var Y = S[W][1];
                            if (Y === null || typeof Y == 'string' && X == Y || Y.test(X))
                                return true;
                        }
                    }
                }
        ...
        function o(P) {
            ...
            var ab = Z.getParent();
            if (ab && ab.getAttribute('_fck_bookmark'))
                Z = ab;
            if (Z.equals(Y)) {
                    ...
                    if (!ag || V[ag] && (ac.getPosition(Z) | 4 | 0 | 8) == 4 + 0 + 8 && (!T.childRule || T.childRule(ac))) {
                        ...
                        if (ah && ((ah.getDtd() || f.span)[S] || U) && (!T.parentRule || T.parentRule(ah))) {
                            ...
                            if (af == 3 || af == 1 && !ac.getChildCount()) {
                                var ai = ac, aj;
                                while (!ai.$.nextSibling && (aj = ai.getParent(), V[aj.getName()]) && (aj.getPosition(Y) | 2 | 0 | 8) == 2 + 0 + 8 && (!T.childRule || T.childRule(aj)))
                                    ai = aj;
                                ad.setEndAfter(ai);
                                if (!ai.$.nextSibling)
                                    ae = true;
                    ...
                    while (ak && al) {
                        if (al.getName() == S) {
                            for (var am in T.attributes) {
                                if (ak.getAttribute(am) == al.getAttribute(am))
                                    ak.removeAttribute(am);
                            }
                            for (var an in T.styles) {
                                if (ak.getStyle(an) == al.getStyle(an))
                                    ak.removeStyle(an);
                            }
                            if (!ak.hasAttributes()) {
                                ak = null;
            ...
            if (P.collapsed) {
                ...
                function ac() {
                    ...
                    for (var aj = 0; aj < af.elements.length; aj++) {
                        ...
                        if (ak == af.block || ak == af.blockLimit)
                            break;
                        if (ab.checkElementRemovable(ak))
                            ah = ak;
                    }
                    for (aj = 0; aj < ag.elements.length; aj++) {
                        ak = ag.elements[aj];
                        if (ak == ag.block || ak == ag.blockLimit)
                            break;
                        if (ab.checkElementRemovable(ak))
                            ai = ak;
                    }
                ...
                while (!ad.equals(aa)) {
                    ...
                    if (ad.type == 1 && this.checkElementRemovable(ad)) {
                        if (ad.getName() == this.element)
                            y(this, ad);
                        else
                            A(ad, J(this)[ad.getName()]);
        ...
        function t(P) {
            var Q;
            if (!((Q = P.getPreviousSourceNode(true, 1)) && Q.is && Q.is('pre')))
                return;
            var R = v(Q.getHtml(), /\n$/, '') + '\n\n' + v(P.getHtml(), /^\n/, '');
            if (c)
                P.$.outerHTML = '<pre>' + R + '</pre>';
            else
                P.setHtml(R);
            Q.remove();
        }
        ...
        function y(P, Q) {
            ...
            for (var V in S) {
                if ((V == 'class' || P._.definition.fullMatch) && Q.getAttribute(V) != K(V, S[V]))
                    continue;
                U = Q.hasAttribute(V);
                Q.removeAttribute(V);
            }
            for (var W in T) {
                if (P._.definition.fullMatch && Q.getStyle(W) != K(W, T[W], true))
                    continue;
                U = U || !!Q.getStyle(W);
                Q.removeStyle(W);
            }
            ...
            if (R)
                for (var S = 0; S < R.length; S++) {
                    ...
                    if (U = P.getAttribute(T)) {
                        var V = R[S][1];
                        if (V === null || V.test && V.test(U) || typeof V == 'string' && U == V)
                            P.removeAttribute(T);
                    }
                }
            B(P);
        ...
        ;
        function C(P) {
            if (!P || P.type != 1 || !f.$removeEmpty[P.getName()])
                return;
            D(P, P.getNext(), true);
            D(P, P.getPrevious());
        }
        ...
        function D(P, Q, R) {
            if (Q && Q.type == 1) {
                ...
                if (S)
                    Q = R ? Q.getNext() : Q.getPrevious();
                if (Q && Q.type == 1 && P.isIdentical(Q)) {
                    var T = R ? P.getLast() : P.getFirst();
                    if (S)
                        (R ? Q.getPrevious() : Q.getNext()).move(P, !R);
                    Q.moveChildren(P, !R);
                    Q.remove();
                    if (T)
                        C(T);
        ...
        function H(P, Q) {
            for (var R in P)
                P[R] = P[R].replace(G, function(S, T) {
                    return Q[T];
                });
        }
        ;
        ...
        function N(P, Q) {
            ...
            for (var R in P) {
                if (!(R in Q && (Q[R] == P[R] || P[R] == 'inherit' || Q[R] == 'inherit')))
                    return false;
            }
            return true;
        }
    ...
    (function() {
        ...
        l.prototype = {getNextParagraph: function(o) {
                ...
                if (!p) {
                    ...
                    p = H.block;
                    if (!p && !O.enforceRealBlocks && J[I.getName()] && q.checkStartOfBlock() && q.checkEndOfBlock())
                        p = I;
                        ...
                        O._.nextNode = p.equals(w) ? null : q.getBoundaryNodes().endNode.getNextSourceNode(true, null, w);
                }
                if (s) {
                    var L = p.getPrevious();
                    if (L && L.type == 1)
                        if (L.getName() == 'br')
                            L.remove();
                        else if (L.getLast() && L.getLast().$.nodeName.toLowerCase() == 'br')
                            L.getLast().remove();
                }
                if (t) {
                    var M = d.walker.bookmark(false, true), N = p.getLast();
                    if (N && N.type == 1 && N.getName() == 'br')
                        if (c || N.getPrevious(M) || N.getNext(M))
                            N.remove();
                }
                if (!O._.nextNode)
                    O._.nextNode = r || p.equals(w) ? null : p.getNextSourceNode(true, null, w);
                return p;
            }};
    ...
    (function() {
        ...
        k.panelButton = e.createClass({base: k.button, $: function(m) {
                ...
                o._ = {panelDefinition: n};
                    ...
                    r.onShow = function() {
                        if (t.className)
                            this.element.getFirst().addClass(t.className + '_panel');
                    ...
                    r.onHide = function() {
                        if (t.className)
                            this.element.getFirst().removeClass(t.className + '_panel');
        ...
        k.floatPanel = e.createClass({$: function(o, p, q, r) {
                ...
                this._ = {panel: t, parentElement: p, definition: q, document: s, iframe: v, children: [], dir: o.lang.dir};
                    ...
                    if (!this._.blurSet) {
                        ...
                        C.on('blur', function(D) {
                            ...
                            if (!F.allowBlur())
                                return;
                            var E;
                            if (c && !F.allowBlur() || (E = D.data.getTarget()) && E.getName && E.getName() != 'iframe')
                                return;
                            if (F.visible && !F._.activeChild && !m)
                                F.hide();
                        }, this);
                        C.on('focus', function() {
                            this._.focused = true;
                    ...
                    t.onEscape = e.bind(function(D) {
                        if (this.onEscape && this.onEscape(D) === false)
                            return false;
                    }, this);
                    e.setTimeout(function() {
                        if (z)
                        ...
                        var D = e.bind(function() {
                            ...
                            if (z ? A < 0 : A + M.width > L.width + K.x)
                                A += M.width * (z ? 1 : -1);
                            if (B + M.height > L.height + K.y)
                                B -= M.height;
                    ...
                    if (this._.activeChild == o && o._.panel._.offsetParentId == q.getId())
                        return;
                    this.hideChild();
    ...
    j.add('menu', {beforeInit: function(l) {
            ...
            l.addMenuItem = function(q, r) {
                if (n[r.group])
                    o[q] = new a.menuItem(this, q, r);
            };
            l.addMenuItems = function(q) {
                for (var r in q)
                    this.addMenuItem(r, q[r]);
            };
                ...
                q._.panelDefinition = o;
                    ...
                    if (!s) {
                        ...
                        s.onEscape = e.bind(function(C) {
                            if (this.onEscape && this.onEscape(C) === false)
                                return false;
                        }, this);
                    ...
                    t.setHtml(x.join(''));
                    if (this.parent)
                        this.parent._.panel.showAsChild(s, this.id, m, n, o, p);
                    else
                        s.showBlock(this.id, m, n, o, p);
                    r.fire('menuShow', [s]);
                }, hide: function() {
    ...
    a.menuItem = e.createClass({$: function(l, m, n) {
            ...
            o.name = m;
                ...
                if (s)
                    n.push('<span class="cke_menuarrow">', '<span>&#', u.editor.lang.dir == 'rtl' ? '9668' : '9658', ';</span>', '</span>');
    ...
    (function() {
        ...
        var q = {modes: {wysiwyg: 1, source: 1}, exec: function(s) {
                switch (s.mode) {
                    ...
                    case 'source':
                        var t = s.textarea.$;
                        if (c)
                            t.createTextRange().execCommand('SelectAll');
                        else {
                            t.selectionStart = 0;
                ...
                s.on('contentDom', function() {
                    ...
                    if (c) {
                        ...
                        u.on('focusin', function(z) {
                            if (z.data.$.srcElement.nodeName != 'BODY')
                                return;
                            if (v) {
                                try {
                                    v.select();
                        ...
                        if (c && b.version < 8)
                            t.getWindow().on('blur', function(z) {
        ...
        d.selection = function(s) {
            ...
            if (c) {
                ...
                if (!u || u.item && u.item(0).ownerDocument != v.document.$ || u.parentElement && u.parentElement().ownerDocument != v.document.$)
                    v.isInvalid = true;
            }
            return v;
        };
        ...
        d.selection.prototype = {getNative: c ? function() {
                ...
                try {
                    ...
                    if (v == 'Control')
                        t = 3;
                    if (u.createRange().parentElement)
                        t = 2;
                } catch (w) {
                }
                return s.type = t;
                ...
                if (!u)
                    ...
                    if (w == v.endContainer && w.nodeType == 1 && v.endOffset - v.startOffset == 1 && r[w.childNodes[v.startOffset].nodeName.toLowerCase()])
                        t = 3;
                }
                return s.type = t;
                        ...
                        if (v)
                            if (!v.collapsed) {
                                ...
                                for (; ; ) {
                                    ...
                                    if (x == (w.getChildCount ? w.getChildCount() : w.getLength()) && !w.isBlockBoundary())
                                        v.setStartAfter(w);
                                    else
                                        break;
                                }
                ...
                var s = this._.cache;
                if (s.selectedElement !== undefined)
                ...
                var t = this, u = e.tryThese(function() {
                    ...
                    var w;
                    if (v.startContainer.equals(v.endContainer) && v.endOffset - v.startOffset == 1 && r[(w = v.startContainer.getChild(v.startOffset)).getName()])
                        return w.$;
                });
                ...
                if (c) {
                    ...
                    for (var u = 0; u < s.length; u++) {
                        ...
                        if (v.collapsed && b.gecko && b.version < 10900 && x.type == 1 && !x.getChildCount())
                            x.appendText('');
    ...
    (function() {
        ...
        d.range.prototype.select = c ? function(n) {
            ...
            if (t) {
                ...
                q.insertBefore(s);
                if (p)
                    x.document.createText(' ').insertBefore(s);
            }
            x.setStartBefore(s);
            s.remove();
            if (o) {
            ...
            if (q.collapsed && n.type == 1 && !n.getChildCount())
                n.append(new d.text(''));
        ...
        var l = {elements: {$: function(m) {
                    ...
                    if (q && m.attributes._cke_resizable) {
                        ...
                        if (r) {
                            ...
                            var u = s && s[1];
                            if (t)
                                q.attributes.width = t;
                            if (u)
                                q.attributes.height = u;
                        }
                    }
                    return q;
                }}};
    ...
    k.richCombo = e.createClass({$: function(l) {
            ...
            n._ = {panelDefinition: m, items: {}, state: 2};
                ...
                if (this.className)
                    m.push(' class="', this.className, ' cke_off"');
                ...
                p.onShow = function() {
                    if (r.className)
                        this.element.getFirst().addClass(r.className + '_panel');
                    r.setState(1);
                ...
                p.onHide = function() {
                    if (r.className)
                        this.element.getFirst().removeClass(r.className + '_panel');
                    r.setState(2);
                    r._.on = 0;
                    if (r.onClose)
                        r.onClose();
                ...
                q.onClick = function(s, t) {
                    ...
                    if (r.onClick)
                        r.onClick.call(r, s, t);
                    if (t)
                        r.setValue(s, r._.items[s]);
                    else
                        r.setValue('');
                    p.hide();
                };
                ...
                if (!(l || m)) {
                    ...
                    n.removeClass('cke_inline_label');
    ...
    a.htmlWriter = e.createClass({base: a.htmlParser.basicWriter, $: function() {
            ...
            n._.rules = {};
            var l = f;
            for (var m in e.extend({}, l.$nonBodyContent, l.$block, l.$listItem, l.$tableContent))
                n.setRules(m, {indent: true, breakBeforeOpen: true, breakAfterOpen: true, breakBeforeClose: !l[m]['#'], breakAfterClose: true});
            ...
            n.setRules('pre', {indent: false});
                ...
                var n = o._.rules[l];
                if (m)
                    o._.output.push(o.selfClosingEnd);
                else {
                    o._.output.push('>');
                    if (n && n.indent)
                        o._.indentation += o.indentationChars;
                }
                if (n && n.breakAfterOpen)
                    o.lineBreak();
            }, attribute: function(l, m) {
                if (typeof m == 'string') {
                ...
                var m = n._.rules[l];
                if (m && m.indent)
                    n._.indentation = n._.indentation.substr(n.indentationChars.length);
                if (n._.indent)
                    n.indentation();
                ...
                var l = this;
                if (l._.output.length > 0)
                    l._.output.push(l.lineBreakChars);
                l._.indent = true;
    ...
    (function() {
        ...
        e.extend(k.dialog, {labeledElement: function(t, u, v, w) {
                ...
                var y = this._.children = [], z = function() {
                    var A = [];
                    if (u.labelLayout != 'horizontal')
                        A.push('<label class="cke_dialog_ui_labeled_label" ', ' id="' + x.labelId + '"', ' for="' + x.inputId + '"', ' style="' + u.labelStyle + '">', u.label, '</label>', '<div class="cke_dialog_ui_labeled_content" role="presentation">', w.call(this, t, u), '</div>');
                    else {
                ...
                l.call(this, u);
                if (!this._['default'])
                    this._['default'] = this._.initValue = u.items[0][1];
                if (u.validate)
                    this.validate = u.valdiate;
                ...
                var x = function() {
                    ...
                    if (u.size != undefined)
                        B.size = u.size;
                    if (u.multiple != undefined)
                        B.multiple = u.multiple;
                    s(y);
                    for (var C = 0, D; C < u.items.length && (D = u.items[C]); C++)
                        A.push('<option value="', e.htmlEncode(D[1] !== undefined ? D[1] : D[0]), '" /> ', e.htmlEncode(D[0]));
        ...
        k.dialog.labeledElement.prototype = e.extend(new k.dialog.uiElement(), {setLabel: function(t) {
                ...
                if (u.getChildCount() < 1)
                    new d.text(t, a.document).appendTo(u);
                else
                    u.getChild(0).$.nodeValue = t;
                return this;
            }, getLabel: function() {
                var t = a.document.getById(this._.labelId);
                if (!t || t.getChildCount() < 1)
                    return '';
                else
        ...
        k.dialog.button.prototype = e.extend(new k.dialog.uiElement(), {click: function() {
                var t = this;
                if (!t._.disabled)
                    return t.fire('click', {dialog: t._.dialog});
                t.getElement().$.blur();
                return false;
            }, enable: function() {
        ...
        k.dialog.checkbox.prototype = e.extend(new k.dialog.uiElement(), {getInputElement: function() {
                ...
                this.setValue(!this.getValue());
                    ...
                    if (!c)
                        return q.onChange.apply(this, arguments);
                    else {
                        t.on('load', function() {
                            var v = this._.checkbox.getElement();
                            v.on('propertychange', function(w) {
                                w = w.data.$;
                                if (w.propertyName == 'checked')
                                    this.fire('change', {value: v.$.checked});
                            }, this);
                        }, this);
                        this.on('change', u);
                    }
        ...
        k.dialog.radio.prototype = e.extend(new k.dialog.uiElement(), {setValue: function(t) {
                ...
                for (var w = 0; w < u.length && (v = u[w]); w++)
                    v.getElement().$.checked = v.getValue() == t;
                this.fire('change', {value: t});
            }, getValue: function() {
                        ...
                        t.on('load', function() {
                            ...
                            for (var x = 0; x < v.length; x++) {
                                ...
                                y.on('propertychange', function(z) {
                                    z = z.data.$;
                                    if (z.propertyName == 'checked' && this.$.checked)
                                        w.fire('change', {value: this.getAttribute('value')});
                                });
                            }
                        }, this);
                        this.on('change', u);
                ...
                if (this.forceIFrame || this.css.length) {
                    ...
                    r.on('keydown', function(u) {
                        ...
                        if (v == 27 || v == (w == 'rtl' ? 39 : 37))
                            if (x.onEscape && x.onEscape(v) === false)
                                u.data.preventDefault();
                    }, this);
                    l = r.getBody();
                } else
                    l = this.document.getById('cke_' + this.id);
                this._.holder = l;
            }
            return l;
    ...
    k.panel.block = e.createClass({$: function(l, m) {
            ...
            if (!n.attributes.title)
                n.attributes.title = n.attributes['aria-label'];
            n.keys = {};
            n._.focusIndex = -1;
            n.element.disableContextMenu();
                ...
                var l = this;
                if (!l.onHide || l.onHide.call(l) !== true)
                    l.element.setStyle('display', 'none');
    ...
    j.add('listblock', {requires: ['panel'], onLoad: function() {
            ...
            k.listBlock = e.createClass({base: k.panel.block, $: function(l, m) {
                    ...
                    p._.groups = {};
                        ...
                        for (var n in l)
                            m.getById(l[n] + '_option').setAttribute('aria-setsize', o._.size);
                        delete o._.size;
                        o._.pendingHtml = [];
                    }, toggle: function(l) {
                        ...
                        for (var o in l)
                            n.getById(l[o]).setStyle('display', '');
                        for (var p in m) {
                        ...
                        var l = o._.items, m = o.element.getDocument();
                        for (var n in l)
                            m.getById(l[n]).removeClass('cke_selected');
    ...
    a.themes.add('default', (function() {
        function l(m, n) {
            ...
            if (p) {
                ...
                if (p.getCustomData('cke_hasshared'))
                    r.hide();
                else
                    p.setCustomData('cke_hasshared', 1);
                o = r.getChild([0, 0, 0, 0]);
                m.on('focus', function() {
                    for (var s = 0, t, u = p.getChildren(); t = u.getItem(s);
                            s++) {
                        if (t.type == 1 && !t.equals(r) && t.hasClass('cke_shared'))
                            t.hide();
                    }
                    r.show();
                });
